...
class GetAllReportsTest(GetReportsTest):
    def test_happypath_get_all_reports(self):
        report_1 = Report(name='Will Smith', lat=3.123123, long=3.345345, description="Halle Berry was an alien the whole time", event_type="encounter", image="pics.com")
        report_1.insert()
        report_2 = Report(name='Mark Zuckerberg', lat=3.123123, long=3.345345, description="I am your reptilian overloard!", event_type="encounter", image="pics.com")
        report_2.insert()
        ...
        assert_payload_field_type_value(
            self, next_result, 'lat', str, report_2.lat
        )
        assert_payload_field_type_value(
            self, next_result, 'long', str, report_2.long
        )
        assert_payload_field_type_value(
        ...
        assert_payload_field_type_value(
            self, next_result, 'lat', str, report_1.lat
        )
        assert_payload_field_type_value(
            self, next_result, 'lat', str, report_1.lat
        )
        ...
        assert_payload_field_type_value(
            self, next_result, 'long', str, report_1.long
        )
        assert_payload_field_type_value(
