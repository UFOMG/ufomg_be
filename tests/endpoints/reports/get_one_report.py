...
class GetReportTest(unittest.TestCase):
    def setUp(self):
        ...
        self.report_1 = Report(name='Mark Zuckerberg', lat=3.123123, long=3.345345, description="I am your reptilian overloard!", event_type="encounter", image="pics.com")
    ...
    def test_happypath_get_a_report(self):
        ...
        assert_payload_field_type_value(
            self, data, 'lat', str, self.report_1.lat
        )
        assert_payload_field_type_value(
            self, data, 'long', str, self.report_1.long
        )
        assert_payload_field_type_value(
