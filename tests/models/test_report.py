...
class AppTest(unittest.TestCase):
    ...
    def test_report_model(self):
        report = Report(name='Mark Zuckerberg', lat=3.123123, long=3.345345, description="I am your reptilian overloard!", event_type="encounter", image="pics.com")
        report.insert()
    ...
    def test_report_model_with_forced_id(self):
        report = Report(name='Mark Zuckerberg', lat=3.123123, long=3.345345, description="I am your reptilian overloard!", event_type="encounter", image="pics.com", report_id=1)
        report.insert()
    ...
    def test_report_model_missing_description(self):
        try:
            report = Report(name=None, lat=3.123123, long=3.345345, description=None, event_type="encounter", image="pics.com")
            report.insert()
        except IntegrityError:
            self.assertTrue(True)
        else:
    ...
    def test_report_model_missing_description(self):
        try:
            report = Report(name=None, lat=3.123123, long=3.345345, description="I am your reptilian overloard!", event_type=None, image="pics.com")
            report.insert()
        except IntegrityError:
            self.assertTrue(True)
        else:
